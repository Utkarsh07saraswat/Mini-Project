...
function Auth({ onAuthenticated }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let finalTenantId
            if (isLogin) {
                finalTenantId = isCustomLogin ? customTenantId : tenantId
            } else {
                finalTenantId = newTenant.toLowerCase().replace(/\s+/g, '-')
            }
                        ...
                        {isLogin ? (
                            ...
                            <>
                                <div className="form-group-new">
                                    ...
                                    <p className="field-hint-new">Tenant ID: <span>{newTenant ? newTenant.toLowerCase().replace(/\s+/g, '-') : '...'}</span></p>
                                </div>
                                <div className="form-group-new">
